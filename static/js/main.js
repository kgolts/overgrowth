    ...
    function initHomepageNav() {
        ...
        function showHideNavItems() {
            ...
            if ($activeSlideNumber == 1) {
                ...
                $slideNavNext.animate({
                    opacity: 0.25
                }).find('a').addClass('disabled');

            } else {

                $slideNavNext.add($slideNavPrev).animate({
                    opacity: 1
                });
        ...
        function scrollToSlide(slideId) {
            ...
            if (typeof customSlideOffset === 'undefined') {
                ...
                htmlbody.animate({
                    scrollTop: ($("#slide-" + slideId).offset().top) + 'px'
                }, 'slow');
                ...
                if (customSlideOffset.indexOf('p') != -1) {
                    ...
                    htmlbody.animate({
                        scrollTop: ($("#slide-" + slideId).offset().top + customSlideOffset) + 'px'
                    }, 'slow');
